...
-- сохраняем в файл 
\copy (select row_to_json(teams) from teams) to '/home/mrskl1f/Desktop/BMSTU/DataBase/lab5/Task2/teams.json';
-- создаем временную таблицу
create temp table teams_import(doc json);
\copy teams_import from '/home/mrskl1f/Desktop/BMSTU/DataBase/lab5/Task2/teams.json';
...
\copy (select row_to_json(players) from players) to '/home/mrskl1f/Desktop/BMSTU/DataBase/lab5/Task2/players.json';
create temp table players_import(doc json);
\copy players_import from '/home/mrskl1f/Desktop/BMSTU/DataBase/lab5/Task2/players.json';
select player.*
